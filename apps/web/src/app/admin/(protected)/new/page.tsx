...
function InlineCreate({ namePlaceholder, onSubmit, onCancel }: InlineCreateProps) {
  ...
  return (
    <form
      ...
      className="mt-2 flex flex-col gap-2 rounded-lg border border-violet-200 bg-violet-50 p-3 dark:border-violet-900 dark:bg-violet-950/20"
    >
      <input
        ref={inputRef}
        type="text"
        ...
        className="w-full rounded border border-zinc-200 bg-white px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
      />
      <input
        type="text"
        value={slug}
        ...
        placeholder="slug (英数字・ハイフン)"
        className="w-full rounded border border-zinc-200 bg-white px-2 py-1.5 font-mono text-xs focus:outline-none focus:ring-2 focus:ring-violet-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-400"
      />
...
export default function NewPostPage() {
  ...
  async function handleAddCategory(name: string, slug: string) {
    const cat = await createCategory({ name, slug });
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="mb-6 text-2xl font-bold text-zinc-900 dark:text-zinc-100">新規投稿</h1>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div>
          <div className="mb-1 flex items-center justify-between">
            ...
            <button
              ...
              className="flex h-5 w-5 items-center justify-center rounded-full text-zinc-400 hover:bg-violet-100 hover:text-violet-600 dark:hover:bg-violet-900/40 dark:hover:text-violet-400"
              aria-label="カテゴリを追加"
            >
              +
            </button>
        ...
        <div>
          <div className="mb-1 flex items-center justify-between">
            <p className="text-sm font-medium text-zinc-700 dark:text-zinc-300">タグ</p>
            <button
              type="button"
